...
> manager.run(dry_run=True)
	...
	-> dry_run == True: returns the wisski uri for all the field values of drop-down menus (controlled vocabulary). such as associated persons, research section, type of resources, etc.
